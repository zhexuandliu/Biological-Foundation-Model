...
pa <- argparser::add_argument(pa, "--dataset_name", type = "character", default = "replogle_k562_essential", help = "The name of the dataset") 
pa <- argparser::add_argument(pa, "--pca_dim", type = "integer", default = 10, nargs = 1, help = "The number of PCA dimensions")

pa <- argparser::add_argument(pa, "--working_dir", type = "character", default = "/Users/zhexuanliu/Documents/GitHub/Biological-Foundation-Model/notebooks/linear_regression_bench/tmp/working_dir", help = "The directory that contains the params, results, scripts etc.")
pa <- argparser::add_argument(pa, "--result_id", type = "character", default = "replogle_k562_pert_embedding", help = "The result_id")
